...
public class DiscardAction : PendingAction
{
    ...
    public DiscardAction(Hand hand, int required)
    {
        _hand = hand;
        _required = required;
    }
    ...
    public bool CanConfirm => _selected.Count == _required;
...

{
    ...
    public override void Resolve(EffectData data)
    {
        ...
        DiscardAction action = new DiscardAction(hand, discardData.amount);
